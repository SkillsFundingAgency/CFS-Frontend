...
namespace CalculateFunding.Frontend.UnitTests.Controllers
{
    ...
    public class FundingLineStructureControllerTests
    {
        ...
        public async Task GetFundingStructures_ReturnsFlatStructureWithCorrectLevelsAndInCorrectOrder()
        {
            ...
            fundingStructureItems?.Count.Should().Be(10);
        ...
        private void ValidScenarioSetup()
        {
	        ...
	        var templateMetadataContents = new TemplateMetadataContents()
	        {
		        ...
		        {
			        new FundingLine {Name = "FundingLine-1"},
			        new FundingLine
			        {
        ...
        private static List<FundingStructureItem> GetValidMappedFundingStructureItems() =>
	        new List<FundingStructureItem>
	        {
		        ...
		        new FundingStructureItem(3, "FundingLine-2-fl-2-fl-1", null, FundingStructureType.FundingLine),
		        new FundingStructureItem(1, "FundingLine-3-withCalculationsAndFundingLines", null,
			        FundingStructureType.FundingLine),
		        new FundingStructureItem(2, "FundingLine-3-calc-1", CalculationId, FundingStructureType.Calculation),
		        new FundingStructureItem(2, "FundingLine-3-calc-2", CalculationId, FundingStructureType.Calculation),
		        new FundingStructureItem(3, "FundingLine-3-calc-2-calc-1", "CalculationIdForTemplateCalculationId2", 
			        FundingStructureType.Calculation),
		        new FundingStructureItem(2, "FundingLine-3-fl-1", null, FundingStructureType.FundingLine)
	        };
    }
}
