...
namespace CalculateFunding.Frontend.UnitTests.ViewModels
{
    [TestClass]
    public class FrontEndMappingProfileTests
    {
        [TestMethod]
        public void FrontEndMappingProfile_ShouldBeValid()
        {
            ...
            action
                .Should()
                .NotThrow("Mapping configuration should be valid for FrontEndMappingProfile");
        }
        ...
        public void CalculationViewModel_MapsAsExpected(Calculation source, CalculationViewModel destination)
        {
            // Arrange
            ...
            //Final deep check - do this last so we can get descriptive errors before, but this'll catch anything else that's slipped though
