...
export const useSpecificationPermissions = (
    ...
    const {data: specPermissions, isLoading, isFetched} =
    ...
    const missingPermissions = permissionsDisabled && requiredPermissions.filter(p => permissionsDisabled.includes(p));
    ...
    return {
        ...
        permissionsDisabled,
        hasPermission,
        hasMissingPermissions: queryOptions.enabled ? missingPermissions !== undefined && missingPermissions.length > 0: false,
        missingPermissions
    }
}