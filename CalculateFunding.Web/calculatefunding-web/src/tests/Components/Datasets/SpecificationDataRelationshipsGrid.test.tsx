...
import SpecificationDataRelationshipsGrid, {
  SpecificationDataRelationshipsGridProps,
} from "../../../components/Datasets/SpecificationDataRelationshipsGrid";
...
describe("<SpecificationDataRelationshipsGrid />", () => {
  ...
  describe("when loading with data", () => {
    it("renders correct data", async () => {
      ...
      const data1Row = screen.getByTestId(
        `tr-relationship-${convertToSlug(dataRelationship1.relationshipId)}`
      );
      ...
      const data2Row = screen.getByTestId(
        `tr-relationship-${convertToSlug(dataRelationship2.relationshipId)}`
      );
      ...
      const data3Row = screen.getByTestId(
        `tr-relationship-${convertToSlug(dataRelationship3.relationshipId)}`
      );
