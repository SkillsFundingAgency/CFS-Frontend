...
export function EditCalculationTestData() {
  ...
  const mockCircularRefErrors = () =>
    jest
      .spyOn(circularRefErrorsHook, "useCalculationCircularDependencies")
      .mockImplementation(() => withCircularRefErrorsResult);
  const mockCircularRefErrorsLoading = () =>
    jest
      .spyOn(circularRefErrorsHook, "useCalculationCircularDependencies")
      .mockImplementation(() => loadingCircularRefErrorsResult);
  const mockNoCircularRefErrors = () =>
    jest
      .spyOn(circularRefErrorsHook, "useCalculationCircularDependencies")
  ...
  const mockFailedBuild = () => {
    jest.mock("../../../services/calculationService", () => {
      ...
      return {
        ...
        getCalculationByIdService: jest.fn(() =>
          Promise.resolve({
            data: mockCalcData,
            status: 200,
          })
