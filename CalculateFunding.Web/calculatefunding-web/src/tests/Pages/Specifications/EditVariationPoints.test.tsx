    ...
    describe("When an existing variation pointer has been set", () => {
        ...
        it('calls save endpoint when save is clicked and redirects to View Specification page', async () => {
            ...
            await waitFor(() => {
                ...
                expect(setProfileVariationPointersServiceSpy).toHaveBeenLastCalledWith(
                    specificationId,
                    [{
...
const setProfileVariationPointersServiceSpy = jest.spyOn(specificationService, 'setProfileVariationPointersService');
