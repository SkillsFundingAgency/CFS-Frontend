...
describe("<EditSpecification /> FDZ with manual tracking", () => {
  ...
  describe("page render tests", () => {
    ...
    it("renders the provider snapshot options", async () => {
  ...
  describe("form submission tests", () => {
    it("it submits form successfully given nothing is changed", async () => {
      ...
      expect(updateSpecSpy).toHaveBeenCalledWith(
        {
          assignedTemplateIds: { "FS-777": template2.templateVersion },
    ...
    it("it submits form given all fields are provided", async () => {
      ...
      expect(updateSpecSpy).toHaveBeenCalledWith(
        {
          assignedTemplateIds: { "FS-777": template1.templateVersion },
...
const fundingStream = fakery.makeFundingStream({ id: "FS-777" });
...
const spec = fakery.makeSpecificationSummary({
  name: "FDZ Spec Without Tracking",
  fundingStreams: [fundingStream],
  fundingPeriod,
  providerVersionId: undefined,
  providerSnapshotId: providerSnapshot2.providerSnapshotId,
  templateIds: { "FS-777": template2.templateVersion },
