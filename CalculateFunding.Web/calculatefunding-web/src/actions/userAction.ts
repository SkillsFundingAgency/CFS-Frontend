...
export const getUserFundingStreamPermissions: ActionCreator<
  ThunkAction<Promise<any>, IUserState, null, IUserActions>
> = () => {
  return async (dispatch, getState) => {
...
export const getHasUserConfirmedSkills: ActionCreator<
  ThunkAction<Promise<any>, IUserState, null, IUserActions>
> = () => {
  return async (dispatch, getState) => {
...
export const updateUserConfirmedSkills: ActionCreator<
  ThunkAction<Promise<any>, IUserState, null, IUserActions>
