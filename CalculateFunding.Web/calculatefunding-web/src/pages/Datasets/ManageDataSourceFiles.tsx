...
export function ManageDataSourceFiles() {
    ...
    function searchDataSourceFiles(searchRequestViewModel: DatasetSearchRequestViewModel) {
        setIsLoading(true);
        searchDatasetService(searchRequestViewModel).then((result) => {
                            ...
                            {datasetSearchData.datasets.map(ds =>
                                    <tr className="govuk-table__row" key={ds.id}>
                                        <th scope="row" className="govuk-table__header">
                                            <Link className="govuk-link" to={`UpdateDataSourceFile/${ds.fundingStreamId}/${ds.id}`}>{ds.name}</Link>
                      ...
                      <span className="govuk-details__summary-text">
                        Data source details
                                                    ...
                                                    <div className="govuk-details__text">
                                                        <p className="govuk-body-s"><strong>Data schema:</strong> {ds.definitionName}</p>
                                                        <p className="govuk-body-s"><strong>Data schema description:</strong> {ds.description}</p>
