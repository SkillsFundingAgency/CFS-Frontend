                ...
                Version notes
                                ...
                                <td className="govuk-table__cell">
                                    <div className="attachment__thumbnail">
                                        <a className="govuk-link" target="_self" tabIndex={-1} aria-hidden="true" href={`/api/datasets/download-dataset-file/${dh.datasetId}/${dh.version}`}>
                                            <svg className="attachment__thumbnail-image thumbnail-image-small " version="1.1" viewBox="0 0 99 140" width="99" height="140" aria-hidden="true">
                                                ...
                                                <path d="M30 68.5h56.5M30 77.34h56.5M30 112.7h56.5M30 95.02h56.5M30 86.18h56.5M30 103.86h56.5" fill="none" stroke-width="2"></path>
                                            </svg>
                                        </a>
                                    </div>
                                    <div className="attachment__details">
                                        <p className="govuk-body-s">
                                            <a className="govuk-link" target="_self" href={`/api/datasets/download-dataset-file/${dh.datasetId}/${dh.version}`}>{dh.blobName}</a></p>
