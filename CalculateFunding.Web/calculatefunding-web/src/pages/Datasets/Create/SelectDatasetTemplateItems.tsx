...
export function SelectDatasetTemplateItems({match}: RouteComponentProps<CreateDatasetRouteProps>) {
    ...
    const {data: templateItems, isLoading} =
        useQuery<PublishedSpecificationTemplateMetadata[], AxiosError>(
    ...
    const filteredItems = useMemo(() => {
        ...
        const filterItemsByName = (searchString: string | undefined, items: PublishedSpecificationTemplateMetadata[]) => {
        ...
        const filterItemsBySelectedStatus = (hideSelected: boolean, items: PublishedSpecificationTemplateMetadata[]) => {
    ...
    async function fetchTemplateItems(specificationId: string | undefined): Promise<PublishedSpecificationTemplateMetadata[]> {
        if (!specificationId) return [];
        const response = await datasetService
            .getPublishedSpecificationTemplateMetadataForCreatingNewDataset(specificationId);
    ...
    return (
        <Main location={Section.Datasets}>
            ...
            <section>
                <Form token="select-template-items"
...
const ReferenceSpecificationDetails = (props: { referenceSpecification: EligibleSpecificationReferenceModel | undefined }) =>
    <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
