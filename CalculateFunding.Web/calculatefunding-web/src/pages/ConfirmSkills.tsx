    ...
    <div>
      ...
      <div className="govuk-width-container">
        <main className="govuk-main-wrapper govuk-main-wrapper--l" id="main-content" role="main">
          ...
          <div className="govuk-grid-row">
            <div className="govuk-grid-column-full">
              <p className="govuk-body">Before using the Calculate funding service you must know the general principles on how the
          ...
          <div className="govuk-grid-row">
            <div className="govuk-grid-column-full">
              ...
              <p className="govuk-body">
                If you are going to write or approve calculations in CFS you must have skills in Visual Basic (VB). These skills are not
                required however if you do not propose to write or approve calculations.
              </p>
            </div>
          </div>
          <div className="govuk-grid-row">
            <div className="govuk-grid-column-full">
              ...
              <p className="govuk-body">
                You should only upload a data source file if you are confident that the data it contains, and the data schema used are
                correct and relevant.
              </p>
              <p className="govuk-body">
                You should only map a data source file to a dataset for a specification if you are confident that the data schema and
                data source file version are correct.
              </p>
            </div>
          </div>
          <div className="govuk-grid-row">
            <div className="govuk-grid-column-full">
              ...
              <p className="govuk-body">
                You can only approve calculations, specifications and funding in CFS if you have the authority to do so.
              </p>
              <p className="govuk-body">
                You can only release funding from CFS to other services for publishing, contracting and payment if you have the
                authority to do so.
              </p>
            </div>
          </div>
