...
export function FundingApprovalSelection() {
    ...
    const proceedToNextStep = () => {
        if (!selectedFundingStream || !selectedFundingPeriod ||  !fundingConfiguration || 
            (fundingConfiguration.approvalMode === ApprovalMode.Batches && batchUpload === undefined)) return;
                        ...
                        <>
                            ...
                            <div className="govuk-form-group">
                                ...
                                <button className="govuk-button"
                                        ...
                                        disabled={!selectedFundingStream || !selectedFundingPeriod ||
                                        (fundingConfiguration.approvalMode === ApprovalMode.Batches && batchUpload === undefined)}
                                        onClick={proceedToNextStep}>Continue
                                </button>
                            </div>
                        </>
                        }
