...
export interface ProviderFundingOverviewRouteOld {
...
/** @deprecated - pls use {@link ../FundingManagement/ProviderFundingOverview} instead
 * TODO: remove this version once Approve/Release Funding goes live */
export function ProviderFundingOverviewOld({ match }: RouteComponentProps<ProviderFundingOverviewRouteOld>) {
