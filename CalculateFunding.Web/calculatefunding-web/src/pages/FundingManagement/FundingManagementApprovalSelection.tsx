...
export function FundingManagementApprovalSelection() {
  ...
  const proceedToNextStep = () => {
    ...
    history.push(
      batchUpload
        ...
        : `/FundingManagementApprovalResults/${selectedFundingStream.id}/${selectedFundingPeriod.id}/${selectedFundingPeriod.specifications[0].id}`
    );
  };
      ...
      <div className="govuk-width-container">
        <div className="govuk-grid-row  govuk-!-margin-bottom-9">
          <div className="govuk-grid-column-full">
            ...
            <h1 className="govuk-heading-xl govuk-!-margin-bottom-2">Funding approvals</h1>
            <h2 className="govuk-caption-xl">Select a funding stream and funding period.</h2>
          </div>
        </div>
              ...
              selectedFundingPeriod.specifications.length > 0 && (
                <>
                  {isLoadingFundingConfiguration && (
                    <LoadingFieldStatus title="Checking for approval mode..." />
                  )}
                  {!isLoadingFundingConfiguration &&
                    fundingConfiguration &&
                    fundingConfiguration.approvalMode && (
                      <>
