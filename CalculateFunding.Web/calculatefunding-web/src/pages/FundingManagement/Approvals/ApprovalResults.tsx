...
export const ApprovalResults = ({
    ...
    function handleApprove() {
        if (
            ...
            if (
                ...
                history.push(
                    `/FundingManagementApprovalsConfirmFunding/${fundingStreamId}/${fundingPeriodId}/${specificationId}/`
                );
            }
        }
    }
    ...
    return <Main location={Section.FundingManagement}>
        ...
        <div className="govuk-grid-row">
            ...
            <div className="govuk-grid-column-two-thirds">
                {isLoading ? <LoadingStatus title={"Loading provider results"}/> :
