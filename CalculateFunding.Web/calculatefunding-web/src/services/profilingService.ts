...
export async function getProfilePatternsForFundingLine(
  fundingStreamId: string,
  fundingPeriodId: string,
  fundingLineId: string
): Promise<AxiosResponse<ProfilingInstallments[]>> {
  return axios(
    `${baseURL}/patterns/fundingStream/${fundingStreamId}/fundingPeriod/${fundingPeriodId}/fundingLineId/${fundingLineId}`,
    {
      method: "GET",
...
export async function getAllProfilePatterns(fundingStreamId: string, fundingPeriodId: string) {
  return axios.get<Promise<FundingStreamPeriodProfilePattern[]>>(
    `${baseURL}/patterns/fundingStream/${fundingStreamId}/fundingPeriod/${fundingPeriodId}/all`
  );
}
...
export async function assignProfilePatternKeyToPublishedProvider(
  ...
  return axios(
    `${baseURL}/patterns/fundingStream/${fundingStreamId}/fundingPeriod/${fundingPeriodId}/provider/${providerId}`,
    {
      method: "POST",
      headers: {
...
export async function getProfileHistoryService(
  fundingStreamId: string,
  fundingPeriodId: string,
  providerId: string
) {
...
export async function getProfileArchiveService(
  fundingStreamId: string,
  fundingPeriodId: string,
  providerId: string
) {
