...
const Wrapper = (args: ModalPopupProps) => {
  ...
  return (
    <div className="govuk-grid-row">
      ...
      <p className="govuk-body-m">Use the isOpen property in the table below to show and hide the modal. </p>
      <ModalPopup {...args} isOpen={isOpen} onClose={handleModalClose}>
        {args.children}
      </ModalPopup>
    </div>
  );
  ...
  children: (
    <div>
      ...
      <p className="govuk-body-m">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nec nibh lacus. Donec feugiat elit at
        mauris suscipit, cursus euismod urna viverra. Pellentesque sed ex quam. Pellentesque pharetra nibh
        rutrum lobortis lobortis.
      </p>
    </div>
  ),
} as ModalPopupProps;
