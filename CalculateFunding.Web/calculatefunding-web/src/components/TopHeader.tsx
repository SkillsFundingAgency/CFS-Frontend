...
export const TopHeader = React.memo(function (props: { location: Section }) {
  ...
  if (windowLocation.includes("https://sb.")) {
    environment = "(Sandbox)";
  }
        ...
        <div className="govuk-header__logo">
          <Link to="/" className="govuk-header__link govuk-header__link--homepage">
            <span className="govuk-header__logotype">
              ...
              <span className="govuk-header__logotype-text govuk-!-margin-left-1">GOV.UK</span>
            </span>
          </Link>
        </div>
        <div className="govuk-header__content">
          <span className="govuk-header__product-name">Calculate funding service {environment}</span>
          <button
            type="button"
            ...
            <ul id="navigation" className="govuk-header__navigation " aria-label="Top Level Navigation">
              <li
                className={
                  ...
                  (props.location === Section.Home ? " govuk-header__navigation-item--active" : "")
                }
              >
              ...
              <li
                className={
                  "govuk-header__navigation-item" +
                  (props.location === Section.Specifications ? " govuk-header__navigation-item--active" : "")
                }
              >
              ...
              <li
                className={
                  "govuk-header__navigation-item" +
                  (props.location === Section.Datasets ? " govuk-header__navigation-item--active" : "")
                }
              >
              ...
              <li
                className={
                  "govuk-header__navigation-item" +
                  (props.location === Section.Results ? " govuk-header__navigation-item--active" : "")
                }
              >
              ...
              <li
                className={
                  "govuk-header__navigation-item" +
                  (props.location === Section.Templates ? " govuk-header__navigation-item--active" : "")
                }
              >
