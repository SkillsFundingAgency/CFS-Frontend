                ...
                <div className="govuk-date-input" id={`timeInput-${inputId}`}>
                    <div className="govuk-date-input__item">
                        <div className="govuk-form-group">
                            ...
                            <input className="govuk-input govuk-date-input__input govuk-input--width-2" type="text"
                                   maxLength={2}
                                   value={localTime}
                                   id={inputId}
                                   name={inputId}
                    ...
                    <div className="govuk-date-input__item">
                        <div className="govuk-form-group">
                            <label className="govuk-label govuk-date-input__label govuk-!-margin-bottom-2" htmlFor="passport-issued-month">
                                Minute
                            </label>
