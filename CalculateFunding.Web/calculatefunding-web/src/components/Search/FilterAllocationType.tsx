  ...
  return (
    <div className="govuk-radios govuk-radios--inline">
      <div className="govuk-radios__item">
        ...
        />
        <label className="govuk-label govuk-radios__label" htmlFor="set-allocation-show">
      ...
      <div className="govuk-radios__item">
        ...
        />
        <label className="govuk-label govuk-radios__label" htmlFor="set-allocation-hide">
      ...
      <div className="govuk-radios__item">
        ...
        />
        <label className="govuk-label govuk-radios__label" htmlFor="set-allocation-only">
