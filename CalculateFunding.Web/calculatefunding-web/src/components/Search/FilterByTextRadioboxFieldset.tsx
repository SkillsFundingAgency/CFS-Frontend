...
export function FilterByTextRadioboxFieldset({fieldId, fieldLabelText, options, onSelectedHandler, onChangeHandler}: FilterByTextRadioboxFieldsetProps) {

    return (<>
        {options.map((option, index) =>
        <FilterByTextRadioboxOption key={index} {...{...option, fieldId, onSelectedHandler, onChangeHandler}} />
        )};
    </>);
}
