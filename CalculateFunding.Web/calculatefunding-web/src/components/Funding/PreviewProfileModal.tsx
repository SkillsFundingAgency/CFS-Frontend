        ...
        async function getPreviewProfile() {
            try {
                const data: ProfileTotal[] = (
                    await previewProfile(specificationId, fundingStreamId, fundingPeriodId, providerId,
        ...
        <div id="preview-profile-modal" className="modal" style={modalDisplayStyle} role="dialog">
            <div className="modal-content">
                <div className="modal-header">
                    ...
                    <button className="govuk-button" onClick={handleClose}>&times;</button>
                </div>
                <div className="modal-body">
                    {isLoading ? <LoadingStatus title="Loading preview..." /> :
                        <>
