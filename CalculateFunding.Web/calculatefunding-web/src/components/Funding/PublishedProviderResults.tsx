...
import {
    removeProvidersFromFundingSelection,
    addProvidersToFundingSelection
} from "../../actions/FundingSelectionActions";
...
export function PublishedProviderResults(props: IPublishedProviderResultsProps) {
    ...
    async function handleRefresh() {
        ...
        try {
            ...
            props.setIsLoadingRefresh(false);
        }
    }
                ...
                <th className="govuk-table__header govuk-body">Provider name
                    ...
                    <>
                        ...
                        <span className="govuk-!-margin-right-2">
                                    <span id="checkbox-checked">{props.selectedResults}</span> / <span
