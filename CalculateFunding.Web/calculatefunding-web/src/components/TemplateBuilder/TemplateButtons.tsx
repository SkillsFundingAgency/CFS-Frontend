      ...
      <div className="govuk-grid-column-full">
        {isEditMode && canEditTemplate && !confirmRestore && (
          <button
            ...
            onClick={handleSave}
            style={isFullScreen ? saveButtonFullScreenStyle : {}}
          >
            Save
          </button>
        )}
        ...
        {hasTemplateContent && canCreateTemplate && !unsavedChanges && (
          <Link
            to={`/Templates/${templateId}/Clone/${templateVersion}`}
        ...
        {!unsavedChanges && hasTemplateContent && (
          <a
            href={`/api/templates/build/${templateId}/export?version=${templateVersion}`}
            target="_blank"
            rel="noopener noreferrer"
            download
            className="govuk-button govuk-button--secondary govuk-!-margin-left-1 right-align govuk-!-margin-right-0"
