...
export function CalculationItem({
  ...
  const [allowedEnumTypeValues, setAllowedEnumTypeValues] = useState<string>(
    node.allowedEnumTypeValues || ""
  );
  ...
  const [calculationA, setCalculationA] = useState<number>(
    node.percentageChangeBetweenAandB ? node.percentageChangeBetweenAandB.calculationA : 0
  );
  const [calculationB, setCalculationB] = useState<number>(
    node.percentageChangeBetweenAandB ? node.percentageChangeBetweenAandB.calculationB : 0
  );
  ...
  const handleCalculationAggregationTypeChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setcalculationAggregationType(
      CalculationAggregationType[e.target.value as keyof typeof CalculationAggregationType]
    );
  };
  ...
  return (
    <div data-testid="sidebar-fundingcalc">
      ...
      <fieldset className="govuk-fieldset" key={node.id}>
        ...
        >
          <label className="govuk-label" htmlFor="calculation-name">
            Name
          </label>
          {isEditMode ? (
            <>
              {errors.filter((e) => e.fieldName === "calculation-name").length === 0 ? (
                <span id="calculation-name-hint" className="govuk-hint">
                  The name of the calculation
                </span>
              ) : (
                errors.map(
                  (error) =>
                    error.fieldName === "calculation-name" && (
            ...
            <div className="govuk-form-group govuk-!-margin-bottom-6">
              <span id="calc-name" className="govuk-hint">
                {name}
              </span>
            </div>
          )}
        ...
        <div
          className={`govuk-form-group ${
            errors.filter((e) => e.fieldName === "calculation-id").length > 0 ? "govuk-form-group--error" : ""
          }`}
        >
          <label className="govuk-label" htmlFor="calculation-id">
            Calculation ID
          </label>
          {isEditMode ? (
            <>
              {errors.map(
                (error) =>
                  error.fieldName === "calculation-id" && (
                    <span key={error.id} className="govuk-error-message govuk-!-margin-bottom-1">
                      <span className="govuk-visually-hidden">Error:</span> {error.message}
                    </span>
                  )
              ...
              <input
                ...
                type="text"
                value={calculationId}
                onChange={handleTemplateCalculationIdChange}
              />
            </>
          ) : (
            <div className="govuk-form-group govuk-!-margin-bottom-6">
              <span id="calculation-id" className="govuk-hint">
                {calculationId}
              </span>
            </div>
          )}
        ...
        <div className="govuk-form-group">
          <label className="govuk-label" htmlFor="calculation-type">
            Type
          </label>
          {isEditMode ? (
            <>
            ...
            <div className="govuk-form-group govuk-!-margin-bottom-6">
              <span id="calculation-type" className="govuk-hint">
                {type}
              </span>
            </div>
          )}
        ...
        {type === CalculationType.Enum && (
          <>
            {isEditMode ? (
              ...
              <div className="govuk-form-group govuk-!-margin-bottom-6">
                <label className="govuk-label" htmlFor="add-tag" aria-labelledby="add-tag">
                  Allowed enum values
                </label>
                <span id="calculation-allowed-enum-values" className="govuk-hint">
        ...
        <div className="govuk-form-group">
          <label className="govuk-label" htmlFor="calculation-formula-text">
            Formula Text
          </label>
          {isEditMode ? (
            <>
            ...
            <div className="govuk-form-group govuk-!-margin-bottom-6">
              <span id="calculation-formula-text" className="govuk-hint">
                {formulaText}
              </span>
            </div>
          )}
        ...
        <div
          className={`govuk-form-group ${
            errors.filter((e) => e.fieldName === "calculation-value-format").length > 0
              ? "govuk-form-group--error"
              : ""
          }`}
        >
          <label className="govuk-label" htmlFor="calculation-value-format">
            Value Format
          </label>
          {isEditMode ? (
            <>
              {errors.map(
                (error) =>
                  error.fieldName === "calculation-value-format" && (
                    <span key={error.id} className="govuk-error-message govuk-!-margin-bottom-1">
                      <span className="govuk-visually-hidden">Error:</span> {error.message}
                    </span>
                  )
              )}
              <span id="calculation-value-format-hint" className="govuk-hint">
                The way the value should show
              </span>
              <select
                className="govuk-select"
                id="calculation-value-format"
                name="calculation-value-format"
                value={valueFormat}
            ...
            <div className="govuk-form-group govuk-!-margin-bottom-6">
              <span id="calculation-value-format" className="govuk-hint">
                {valueFormat}
              </span>
            </div>
          )}
        ...
        <div className="govuk-form-group">
          <label className="govuk-label" htmlFor="calculation-aggregation-type">
            Aggregation Type
          </label>
          {isEditMode ? (
            <>
              ...
              >
                ...
                {type !== CalculationType.Enum && (
                  <>
                    ...
                    <option value={AggregrationType.PercentageChangeBetweenAandB}>
                      PercentageChangeBetweenAandB
                    </option>
                  </>
                )}
            ...
            <div className="govuk-form-group govuk-!-margin-bottom-6">
              <span id="calculation-aggregation-type" className="govuk-hint">
                {aggregationType}
              </span>
            </div>
          )}
        ...
        {aggregationType === AggregrationType.GroupRate && (
          <>
            <div
              className={`govuk-form-group ${
                errors.filter((e) => e.fieldName === "group-rate-numerator").length > 0
                  ? "govuk-form-group--error"
                  : ""
              }`}
            >
              <label className="govuk-label" htmlFor="group-rate-numerator">
                Numerator
              </label>
              {isEditMode ? (
                <>
                  {errors.map(
                    (error) =>
                      error.fieldName === "group-rate-numerator" && (
                        <span key={error.id} className="govuk-error-message govuk-!-margin-bottom-1">
                          <span className="govuk-visually-hidden">Error:</span> {error.message}
                        </span>
                      )
                  ...
                  <select
                    className="govuk-select"
                    id="group-rate-numerator"
                    name="group-rate-numerator"
                    value={numerator}
                  ...
                  >
                    ...
                    {calcs &&
                      calcs
                        .filter(
                          (c) =>
                            c.templateCalculationId !== node.templateCalculationId &&
                            c.aggregationType === AggregrationType.Sum &&
                            c.templateCalculationId !== denominator
                        )
                        .map((c) => (
                          <option
                            key={c.templateCalculationId}
                            value={c.templateCalculationId}
                          >{`${c.name} (${c.templateCalculationId})`}</option>
                        ))}
                  </select>
                </>
              ) : (
                <div className="govuk-form-group govuk-!-margin-bottom-6">
                  <span id="group-rate-numerator" className="govuk-hint">
                    {numerator}
                  </span>
                </div>
              )}
            ...
            <div
              className={`govuk-form-group ${
                errors.filter((e) => e.fieldName === "group-rate-denominator").length > 0
                  ? "govuk-form-group--error"
                  : ""
              }`}
            >
              <label className="govuk-label" htmlFor="group-rate-denominator">
                Denominator
              </label>
              {isEditMode ? (
                <>
                  {errors.map(
                    (error) =>
                      error.fieldName === "group-rate-denominator" && (
                        <span key={error.id} className="govuk-error-message govuk-!-margin-bottom-1">
                          <span className="govuk-visually-hidden">Error:</span> {error.message}
                        </span>
                      )
                  ...
                  <select
                    className="govuk-select"
                    id="group-rate-denominator"
                    name="group-rate-denominator"
                    value={denominator}
                ...
                <div className="govuk-form-group govuk-!-margin-bottom-6">
                  <span id="group-rate-denominator" className="govuk-hint">
                    {denominator}
                  </span>
                </div>
              )}
        ...
        {aggregationType === AggregrationType.PercentageChangeBetweenAandB && (
          <>
            <div
              className={`govuk-form-group ${
                errors.filter((e) => e.fieldName === "percentage-change-calculation-a").length > 0
                  ? "govuk-form-group--error"
                  : ""
              }`}
            >
              <label className="govuk-label" htmlFor="percentage-change-calculation-a">
                Calculation A
              </label>
              {isEditMode ? (
                <>
                  {errors.map(
                    (error) =>
                      error.fieldName === "percentage-change-calculation-a" && (
                        <span key={error.id} className="govuk-error-message govuk-!-margin-bottom-1">
                          <span className="govuk-visually-hidden">Error:</span> {error.message}
                        </span>
                      )
                  ...
                  >
                    ...
                    {calcs &&
                      calcs
                        ...
                        .map((c) => (
                          <option key={c.templateCalculationId} value={c.templateCalculationId}>
                            {c.name}
                          </option>
                        ))}
                  </select>
                ...
                <div className="govuk-form-group govuk-!-margin-bottom-6">
                  <span id="percentage-change-calculation-a" className="govuk-hint">
                    {calculationA}
                  </span>
                </div>
              )}
            ...
            <div
              className={`govuk-form-group ${
                errors.filter((e) => e.fieldName === "percentage-change-calculation-b").length > 0
                  ? "govuk-form-group--error"
                  : ""
              }`}
            >
              <label className="govuk-label" htmlFor="percentage-change-calculation-b">
                Calculation B
              </label>
              {isEditMode ? (
                <>
                  {errors.map(
                    (error) =>
                      error.fieldName === "percentage-change-calculation-b" && (
                        <span key={error.id} className="govuk-error-message govuk-!-margin-bottom-1">
                          <span className="govuk-visually-hidden">Error:</span> {error.message}
                        </span>
                      )
                ...
                <div className="govuk-form-group govuk-!-margin-bottom-6">
                  <span id="percentage-change-calculation-b" className="govuk-hint">
                    {calculationB}
                  </span>
                </div>
              )}
            ...
            <div
              className={`govuk-form-group ${
                errors.filter((e) => e.fieldName === "percentage-change-calculation-aggregation-type")
                  .length > 0
                  ? "govuk-form-group--error"
                  : ""
              }`}
            >
              <label className="govuk-label" htmlFor="percentage-change-calculation-aggregation-type">
              ...
              {isEditMode ? (
                <>
                  {errors.map(
                    (error) =>
                      error.fieldName === "percentage-change-calculation-aggregation-type" && (
                        <span key={error.id} className="govuk-error-message govuk-!-margin-bottom-1">
                          <span className="govuk-visually-hidden">Error:</span> {error.message}
                        </span>
                      )
                  ...
                  <select
                    ...
                    value={calculationAggregationType}
                    onChange={handleCalculationAggregationTypeChange}
                  >
                ...
                <div className="govuk-form-group govuk-!-margin-bottom-6">
                  <span id="percentage-change-calculation-aggregation-type" className="govuk-hint">
                    {calculationAggregationType}
                  </span>
                </div>
              )}
                  ...
                  >
                    ...
                    {calcs &&
                      calcs
                        ...
                        .map((c) => (
                          <option key={c.templateCalculationId} value={c.id}>
                            {c.name}
                          </option>
                        ))}
                  </select>
