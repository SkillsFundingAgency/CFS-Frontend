...
export function LoadingStatus(props: { id?: string, title: string, subTitle?: string, description?: string, hidden?: boolean,  testid?: string }) {

    return (
        <div id={props.id} className="govuk-grid-row" hidden={props.hidden} data-testid={props.testid}>
