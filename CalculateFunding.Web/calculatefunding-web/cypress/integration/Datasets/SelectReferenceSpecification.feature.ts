...
context('Select reference Specification for creating a new dataset', () => {
    ...
    describe('when page has loaded', () => {
        it('has correct title', () => {
            cy.findByRole('heading', {name: /Create data set/})
                .should('exist');
        })
        it('has link to spec', () => {
...
context('Create new dataset when no available specifications to reference', () => {
    ...
    describe('when page has loaded', () => {
        ...
        it('renders the no-options message', () => {
            cy.findByText(/There are no funding streams to select. There is either no data sharing enabled with the funding stream of the current specification or there are no enabled funding streams with released data./)
                .should('exist');
        });
        it('has no Continue button', () => {
            cy.findByRole('button', {name: /Continue/})
