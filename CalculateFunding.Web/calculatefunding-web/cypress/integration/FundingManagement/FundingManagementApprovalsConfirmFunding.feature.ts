...
context("Funding management approval confirmation page", () => {
    ...
    before(() => {
        ...
        routes() {
            ...
            this.get("/users/effectivepermissions/4aeb22b6-50e1-48b6-9f53-613234b78a55",() =>{
                return {}
            });
            this.get("/policy/configuration/DSG/FY-2021", () =>{
                return { "organisationGroupings":[{ "groupTypeIdentifier":"UKPRN","groupingReason":0,"groupTypeClassification":"LegalEntity","organisationGroupTypeCode":"LocalAuthority","providerTypeMatch":[],"providerStatus":null },{ "groupTypeIdentifier":"LACode","groupingReason":1,"groupTypeClassification":"GeographicalBoundary","organisationGroupTypeCode":"LocalAuthority","providerTypeMatch":[],"providerStatus":null },{ "groupTypeIdentifier":"LocalAuthorityClassificationTypeCode","groupingReason":1,"groupTypeClassification":"GeographicalBoundary","organisationGroupTypeCode":"LocalGovernmentGroup","providerTypeMatch":[],"providerStatus":null },{ "groupTypeIdentifier":"GovernmentOfficeRegionCode","groupingReason":1,"groupTypeClassification":"GeographicalBoundary","organisationGroupTypeCode":"GovernmentOfficeRegion","providerTypeMatch":[],"providerStatus":null },{ "groupTypeIdentifier":"CountryCode","groupingReason":1,"groupTypeClassification":"GeographicalBoundary","organisationGroupTypeCode":"Country","providerTypeMatch":[],"providerStatus":null }],"id":"config-DSG-FY-2021","fundingStreamId":"DSG","fundingPeriodId":"FY-2021","defaultTemplateVersion":"1.1","variations":[{ "name":"TemplateUpdated","order":0,"fundingLineCodes":null },{ "name":"FundingSchemaUpdated","order":1,"fundingLineCodes":null },{ "name":"ProviderMetadata","order":2,"fundingLineCodes":null },{ "name":"FundingUpdated","order":4,"fundingLineCodes":null },{ "name":"ProfilingUpdated","order":5,"fundingLineCodes":null },{ "name":"ReProfiling","order":6,"fundingLineCodes":null }],"errorDetectors":["TrustIdMismatchErrorDetector","FundingLineValueProfileMismatchErrorDetector","PostPaymentOutOfScopeProviderErrorDetector","ProviderNotFundedErrorDetector"],"approvalMode":"All","providerSource":"CFS","paymentOrganisationSource":"PaymentOrganisationAsProvider","updateCoreProviderVersion":"Manual","enableUserEditableCustomProfiles":false,"enableUserEditableRuleBasedProfiles":false,"runCalculationEngineAfterCoreProviderUpdate":true,"enableConverterDataMerge":false,"successorCheck":false,"indicativeOpenerProviderStatus":[],"allowedPublishedFundingStreamsIdsToReference":[],"releaseManagementVariations":[],"releaseChannels":[],"releaseActionGroups":[] };
            })
            ...
            this.get("/results/specification-calculation-results-metadata/4aeb22b6-50e1-48b6-9f53-613234b78a55", () => {
                return {
                    "specificationId": "4aeb22b6-50e1-48b6-9f53-613234b78a55",
                    "lastUpdated": "2021-01-07T12:56:37.6893023+00:00"
                };
            });
            this.post("/publishedProviders/search", () => {
                return {
                    "providers":[
                        {
            ...
            this.get("/specs/specification-summary-by-id/4aeb22b6-50e1-48b6-9f53-613234b78a55", () => {
                return {
                    "providerSource":"CFS",
                    "fundingPeriod":{
                        "id":"FY-2021",
