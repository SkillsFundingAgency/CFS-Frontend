...
namespace CalculateFunding.Frontend.Pages.Approvals
{
    public class ViewFundingModel : PageModel
    {
        ...
        public string SelectedSpecificationId { get; set; }

        public ViewFundingModel(ISpecsApiClient specsApiClient, IResultsApiClient resultsApiClient, IMapper mapper)
        {
        ...
        // Useful for setup of unit testing
