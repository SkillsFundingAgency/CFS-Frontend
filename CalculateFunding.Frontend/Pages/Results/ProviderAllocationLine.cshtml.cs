namespace CalculateFunding.Frontend.Pages.Results
{
    ...
    public class ProviderAllocationLinePageModel : PageModel
    {
        private readonly IResultsApiClient _resultsApiClient;
        private readonly IMapper _mapper;
        private readonly ISpecsApiClient _specsApiClient;

        public ProviderAllocationLinePageModel(IResultsApiClient resultsApiClient, IMapper mapper, ISpecsApiClient specsApiClient)
        {
