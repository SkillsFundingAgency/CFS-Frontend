...
namespace calculateFunding.editTemplateCalculation {

    export class EditTemplateCalculationViewModel {
        ...
        private options: IEditTemplateCalculationViewModelOptions;
        ...
        constructor(options: IEditTemplateCalculationViewModelOptions) {
        ...
        public registerMonacoProviders(viewModel: EditTemplateCalculationViewModel) {
