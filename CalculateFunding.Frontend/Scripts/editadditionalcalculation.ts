...
namespace calculateFunding.editadditionalcalculation {

    export class EditAdditionalCalculationViewModel {
        ...
        public saveCalculation() {
            if (this.state() === "idle" && this.canSaveCalculation()) {
                ...
                let request = $.ajax({
                    url: `/api/specs/${this.options.specificationId}/calculations/${this.options.calculationId}/editadditionalcalculation`,
                    data: JSON.stringify(data),
                    dataType: "json",
                    method: "POST",
                    contentType: "application/json"
        ...
        public registerMonacoProviders(viewModel: EditAdditionalCalculationViewModel) {
